...
class KaspaProcessManager extends EventEmitter{
	...
	async start(daemons={}) {
		...
		const startupTypeOrder = ['anumad','mqtt','mysql','pgsql','kasparovsyncd','kasparovd', 'gpuminer', 'anumaminer','txgen','app'];
		const typeMap = { };
	...
	async stop() {
		//const shutdownTypeOrder = ['anumad','mqtt','mysql','pgsql','kasparovsyncd','kasparovd','simulator','txgen'];
		//const typeMap = { };
